...
# Install with
# python3 -m pip install git+https://github.com/finsberg/in1910-project3-random-walk.git
import labyrinths
from labyrinths import InvalidSquareError

# Import from file called `maze_walker.py`
...
@pytest.fixture
def maze():
    return labyrinths.example()


@pytest.fixture
def circle():
    return labyrinths.circular()
